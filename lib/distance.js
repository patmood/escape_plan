module.exports.allDists = function(airports, origin, next) {
  var distArr = []
    , distObj = {
        'summary': {}
      , 'distances': {}
...
module.exports.furthestAirport = function(airports, origin, next) {
  var distArr = []
    , dist
...
var calcDist = function(origin, dest){
  ...
  var lat1 = parseFloat(origin.lat)
    , lon1 = parseFloat(origin.lng) // Rome to rio uses lng
